...
// Serialize a SettingsFile back to the compiled-binary .settings format.
...
// footer bytes are written back verbatim. Verified against all 3754 real client
// .settings files across every available client version/leak.
