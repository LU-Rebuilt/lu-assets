...
NifRenderMaterial build_material_for_node(
    ...
    if (tex_prop) {
        ...
        out.dark_texture_transform = tex_prop->dark_texture_transform;
        ...
        out.detail_texture_transform = tex_prop->detail_texture_transform;
        ...
        out.gloss_texture_transform = tex_prop->gloss_texture_transform;
